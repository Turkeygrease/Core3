glowie_reb_b = Creature:new {
	...
	primaryAttacks = merge(brawlermaster,marksmanmaster,carbineermid,teraskasimid),
	secondaryAttacks = { }
}

CreatureTemplates:addCreatureTemplate(glowie_reb_b, "glowie_reb_b")
