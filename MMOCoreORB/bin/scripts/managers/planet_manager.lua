...
corellia = {
	...
	planetObjects = {
--		{templateFile = "object/tangible/terminal/terminal_event_buffs.iff", ox = 0, oy = -0.664289, oz = 0, ow = 0.747476, x = -133.192, z = 28, y = -4711.16, parentid = 0},
--		{templateFile = "object/tangible/terminal/terminal_event_buffs.iff", ox = 0, oy = 0.346712, oz = 0, ow = 0.937972, x = -5049.64, z = 21, y = -2304.52, parentid = 0},
--		{templateFile = "object/tangible/terminal/terminal_event_buffs.iff", ox = 0, oy = 0.290803, oz = 0, ow = 0.956783, x = 3330.38, z = 308, y = 5517.14, parentid = 0},
--		{templateFile = "object/tangible/terminal/terminal_event_buffs.iff", ox = 0, oy = -0.666281, oz = 0, ow = 0.745701, x = -136.437, z = 28, y = -4730.23, parentid = 0}
	}
}
...
lok = {
	...
	planetObjects = {
--		{templateFile = "object/tangible/terminal/terminal_event_buffs.iff", ox = 0, oy = 0.999879, oz = 0, ow = 0.015506, x = 464.677, z = 8.75806, y = 5506.49, parentid = 0}
	}
}
...
naboo = {
	...
	planetObjects = {
--		{templateFile = "object/tangible/terminal/terminal_event_buffs.iff", ox = 0, oy = 0.715602, oz = 0, ow = -0.698509, x = 4824.53, z = 4.17, y = -4704.9, parentid = 0},
--		{templateFile = "object/tangible/terminal/terminal_event_buffs.iff", ox = 0, oy = 0.309582, oz = 0, ow = 0.950873, x = -4876.99, z = 6, y = 4142.12, parentid = 0},
--		{templateFile = "object/tangible/terminal/terminal_event_buffs.iff", ox = 0, oy = -0.0116238, oz = 0, ow = 0.999932, x = 5193.14, z = -192, y = 6680.25, parentid = 0},
--		{templateFile = "object/tangible/terminal/terminal_event_buffs.iff", ox = 0, oy = -0.0116238, oz = 0, ow = -0.686427, x = 1445.8, z = 13, y = 2771.98, parentid = 0}
	}
}
...
tatooine = {
	...
	planetTravelPoints = {
		{name = "Mos Eisley Shuttleport", x = 3504, z = 5, y = -4904, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1},
	...
	planetObjects = {
--		{templateFile = "object/tangible/terminal/terminal_event_buffs.iff", ox = 0, oy = 0.768226, oz = 0, ow = -0.640178, x = 3533.04, z = 5, y = -4796, parentid = 0},
--		{templateFile = "object/tangible/terminal/terminal_event_buffs.iff", ox = 0, oy = -0.486657, oz = 0, ow = 0.873593, x = -1271.07, z = 12, y = -3590.22, parentid = 0},
--		{templateFile = "object/tangible/terminal/terminal_event_buffs.iff", ox = 0, oy = -0.514176, oz = 0, ow = 0.857684, x = -2896.35, z = 5, y = 2130.87, parentid = 0},
--		{templateFile = "object/tangible/terminal/terminal_event_buffs.iff", ox = 0, oy = 0.989124, oz = 0, ow = -0.147086, x = 1299.08, z = 7, y = 3145.21, parentid = 0}
	}
}
...
dungeon1 = { -- Space Zone
	...
	gcwEnabled = 0,
				   ...
				   -------- Ensure to enable each zone in this file as we enable zones for each instance --------

arena_tatooine = { -- Planet Zone
	weatherEnabled = 1,
	gcwEnabled = 0,
}

dungeon2 = { -- Planet Zone
	weatherEnabled = 0,
	gcwEnabled = 0,
}
--[[
dungeon3 = { -- Planet Zone
	weatherEnabled = 0,
	gcwEnabled = 0,
}

dungeon4 = { -- Planet Zone
	weatherEnabled = 0,
	gcwEnabled = 0,
}

dungeon5 = { -- Planet Zone
	weatherEnabled = 0,
	gcwEnabled = 0,
}
...
dungeon10 = { -- Space Zone
	weatherEnabled = 0,
	gcwEnabled = 0,
}

dungeon11 = { -- Space Zone
	weatherEnabled = 0,
	gcwEnabled = 0,
}--]]
