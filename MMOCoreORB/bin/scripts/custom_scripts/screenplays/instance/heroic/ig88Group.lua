...
registerScreenPlay("ig88Group", false)

--------------------------------------
--   Initialize screenplay           -
--------------------------------------
function ig88Group:start(pBuilding)
	--print("ig 88 Group ScreenPlay Started",pBuilding)
	self:spawnMobiles(pBuilding)
end
--Spawn Initial Mobiles
function ig88Group:spawnMobiles(pBuilding)
	...
	local pTrigger = spawnMobile(zone, "ig_mouse_droid", 0, 0, 0, 0, -99, bID+1)
        createObserver(OBJECTDESTRUCTION, "ig88Group", "notifyTriggerDead", pTrigger)
	return 0
end
--Trigger Death Event
function ig88Group:notifyTriggerDead(pTrigger, pPlayer)
	...
	createObserver(OBJECTDESTRUCTION, "ig88Group", "notifyBossDead", pBoss)
	createEvent(1800000, "Ihelp", "despawnBoss", pBoss,"")--Boss Despawn Timer
	return 0
end
--Boss Death Event
function ig88Group:notifyBossDead(pBoss, pPlayer)
...
function ig88Group:resetScreenplayStatus(pBuilding)
	Ihelp:despawnAdds(pBuilding)
