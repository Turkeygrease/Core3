...
includeFile("../custom_scripts/screenplays/worldbuilder/decor_items.lua")
...
function AdminDecor:showCategories(pPlayer)
	local sui = SuiListBox.new("AdminDecor", "showItems") 
...
function AdminDecor:showItems(pPlayer, pSui, eventIndex, args)
	...
	local sui = SuiListBox.new("AdminDecor", "itemSelection") 
...
function AdminDecor:itemSelection(pPlayer, pSui, eventIndex, args)
	...
	self:showItems(pPlayer, pSui, eventIndex, catIndex-1) 
end
