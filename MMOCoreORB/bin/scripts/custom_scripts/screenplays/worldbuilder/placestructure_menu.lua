...
includeFile("../custom_scripts/screenplays/worldbuilder/placestructure_items.lua")
...
function AdminPlaceStructure:showCategories(pPlayer)
	...
	promptText = (promptText .. "TIP: Use /wardev admin showRuler to show a green line that will help you better visualize the alignment.\n\n")
