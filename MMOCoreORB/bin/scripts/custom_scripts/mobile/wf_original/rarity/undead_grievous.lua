undead_grievous = Creature:new {
	objectName = "",
	customName = "Undead Grievous",
	...
	templates = {"object/mobile/undead_grievous.iff"},
	scale = 1.5,
	lootGroups = {
		{
	        groups = {
...
CreatureTemplates:addCreatureTemplate(undead_grievous, "undead_grievous")
