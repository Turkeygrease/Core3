fluorescent_reptilian_flier = Creature:new {
	objectName = "",
	...
	templates = {"object/mobile/fluorescent_reptilian_flier.iff"},
	scale = 1.5,
	lootGroups = {
		{
	        groups = {
...
CreatureTemplates:addCreatureTemplate(fluorescent_reptilian_flier, "fluorescent_reptilian_flier")
