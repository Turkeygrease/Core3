toxic_spider_monk_droid = Creature:new {
	objectName = "",
	customName = "Toxic Monk Spider",
	socialGroup = "jabba",
	faction = "",
	...
	templates = {"object/mobile/toxic_spider_monk_droid.iff"},
	scale = 1.5,
	lootGroups = {
		{
	        groups = {
...
CreatureTemplates:addCreatureTemplate(toxic_spider_monk_droid, "toxic_spider_monk_droid")
