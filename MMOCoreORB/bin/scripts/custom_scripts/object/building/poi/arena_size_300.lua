object_building_poi_arena_size_300 = object_building_poi_shared_arena_size_300:new {
	customName = "Arena300 Template",
...
ObjectTemplates:addTemplate(object_building_poi_arena_size_300, "object/building/poi/arena_size_300.iff")
