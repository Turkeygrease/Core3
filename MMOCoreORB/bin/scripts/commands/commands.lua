...
RunSlashCommandsFile("bhshield.lua")
RunSlashCommandsFile("orbitalStrike.lua")
RunSlashCommandsFile("SetPvP.lua")
RunSlashCommandsFile("poisongascloud.lua")
RunSlashCommandsFile("escape.lua")
RunSlashCommandsFile("dirtyTrick.lua")
RunSlashCommandsFile("standfast.lua")
RunSlashCommandsFile("remotedetonator.lua")
RunSlashCommandsFile("stasisField.lua")
RunSlashCommandsFile("pistolwhip.lua")
RunSlashCommandsFile("synapticBoost.lua")
RunSlashCommandsFile("inspiration.lua")
RunSlashCommandsFile("forceShroud.lua")
RunSlashCommandsFile("cripplingVortex.lua")
RunSlashCommandsFile("forceStorm.lua")
RunSlashCommandsFile("narrowEscape.lua")