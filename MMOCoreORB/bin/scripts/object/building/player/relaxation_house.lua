...
--		{templateFile = "object/tangible/sign/player/house_address.iff", x = 4.34, z = 3.4, y = 18.40, ox = 0, oy = 0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1},
		...
		{templateFile = "object/tangible/furniture/effect_control/relaxation_house_control.iff", x = 6.2, z = 2.7, y = 9.622, ow = -5.96046e-08, ox = 0, oz = 0, oy = -1, cellid = 1, containmentType = -1},
	}
}
