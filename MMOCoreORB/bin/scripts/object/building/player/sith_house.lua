...
object_building_player_sith_house = object_building_player_shared_sith_house:new {
	...
	childObjects = {
			...
			{templateFile = "object/tangible/terminal/terminal_player_structure.iff", x = 3.61035, z = 1.22656, y = 2.15219, ow = -5.96046e-08, ox = 0, oz = 0, oy = -1, cellid = 1, containmentType = -1},
