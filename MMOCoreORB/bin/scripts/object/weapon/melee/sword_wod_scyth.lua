...
object_weapon_melee_sword_wod_scyth = object_weapon_melee_shared_sword_wod_scyth:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_sword_wod_scyth, "object/weapon/melee/sword_wod_scyth.iff")
