...
object_weapon_melee_pvp_bf_knuckler = object_weapon_melee_shared_pvp_bf_knuckler:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_pvp_bf_knuckler, "object/weapon/melee/pvp_bf_knuckler.iff")
