...
object_weapon_melee_wookiee_knuckler_wod = object_weapon_melee_shared_wookiee_knuckler_wod:new {
	...
	experimentalMin = {0, 0, 217, 260, 3.6, 64, 13750, 5, 5, 1, 5, 5, 36, 54, 36},
	experimentalMax = {0, 0, 313, 411, 2.5, 96, 21500, 5, 45, 21, 35, 5, 18, 30, 18},
...
ObjectTemplates:addTemplate(object_weapon_melee_wookiee_knuckler_wod, "object/weapon/melee/wookiee_knuckler_wod.iff")
