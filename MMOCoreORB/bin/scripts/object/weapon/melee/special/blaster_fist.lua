...
object_weapon_melee_special_blaster_fist = object_weapon_melee_special_shared_blasterfist:new {
	...
	experimentalMin = {0, 0, 170, 210, 3.6, 64, 13750, 5, 5, 1, 5, 5, 36, 54, 36},
	experimentalMax = {0, 0, 260, 350, 2.5, 96, 21500, 5, 45, 21, 35, 5, 18, 30, 18},
...
ObjectTemplates:addTemplate(object_weapon_melee_special_blaster_fist, "object/weapon/melee/special/blaster_fist.iff")
