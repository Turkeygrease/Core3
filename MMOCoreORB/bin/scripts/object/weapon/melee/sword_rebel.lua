...
object_weapon_melee_sword_rebel = object_weapon_melee_shared_sword_rebel:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_sword_rebel, "object/weapon/melee/sword_rebel.iff")
