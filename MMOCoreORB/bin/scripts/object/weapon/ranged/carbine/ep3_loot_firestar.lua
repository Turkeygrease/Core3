...
object_weapon_ranged_carbine_ep3_loot_firestar = object_weapon_ranged_carbine_shared_ep3_loot_firestar:new {
   customObjectName = "Mustafarian Firestar Carbine",
	...
	experimentalMin = {0, 0, 245, 370, 6, 8, 30, 1750, 10, -10, 50, 0, 33, 52, 26},
	experimentalMax = {0, 0, 350, 450, 2.1, 16, 65, 1800, 10, -10, 50, 10, 18, 28, 14},
