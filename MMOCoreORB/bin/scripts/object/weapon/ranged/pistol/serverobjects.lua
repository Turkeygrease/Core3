...
includeFile("weapon/ranged/pistol/pistol_kyd21.lua");
...
includeFile("weapon/ranged/pistol/pistol_trando_suppressor.lua");
includeFile("weapon/ranged/pistol/pistol_wookiee.lua");
includeFile("weapon/ranged/pistol/wookiee_bowcaster.lua");
includeFile("weapon/ranged/pistol/som_disruptor_pistol.lua");
includeFile("weapon/ranged/pistol/pistol_de_10_elite.lua");
