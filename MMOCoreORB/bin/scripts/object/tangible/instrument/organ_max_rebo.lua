...
object_tangible_instrument_organ_max_rebo = object_tangible_instrument_shared_organ_max_rebo:new {
...
ObjectTemplates:addTemplate(object_tangible_instrument_organ_max_rebo, "object/tangible/instrument/organ_max_rebo.iff")
