...
object_tangible_wearables_necklace_necklace_lifeday = object_tangible_wearables_necklace_shared_necklace_lifeday:new {
	playerRaces = {
...
ObjectTemplates:addTemplate(object_tangible_wearables_necklace_necklace_lifeday, "object/tangible/wearables/necklace/necklace_lifeday.iff")
