...
--	objectMenuComponent = "CybtorsoMenuComponent",
--	attributeListComponent = "CybtorsoAttributeListComponent",
--	dataObjectComponent = "CybtorsoDataComponent",				
}
