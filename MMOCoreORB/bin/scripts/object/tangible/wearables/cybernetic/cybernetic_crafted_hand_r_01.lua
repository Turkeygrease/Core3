...
ObjectTemplates:addTemplate(object_tangible_wearables_cybernetic_cybernetic_crafted_hand_r_01, "object/tangible/wearables/cybernetic/cybernetic_crafted_hand_r_01.iff")
