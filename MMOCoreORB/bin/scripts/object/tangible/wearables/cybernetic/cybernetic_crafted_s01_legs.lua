...
--	objectMenuComponent = "CyblegsMenuComponent",
--	attributeListComponent = "CyblegsAttributeListComponent",
--	dataObjectComponent = "CyblegsDataComponent",
}
