...
object_tangible_wearables_backpack_gmf_01 = object_tangible_wearables_backpack_shared_backpack_gmf_01:new {
	playerRaces = {
...
,
	...
	customName = "Huttlet Backpack",

}

ObjectTemplates:addTemplate(object_tangible_wearables_backpack_gmf_01, "object/tangible/wearables/backpack/backpack_gmf_01.iff")
