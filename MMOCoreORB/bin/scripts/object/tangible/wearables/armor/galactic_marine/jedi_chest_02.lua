...
object_tangible_wearables_armor_galactic_marine_jedi_chest_02 = object_tangible_wearables_armor_marauder_shared_armor_marauder_s03_chest_plate:new {
	playerRaces = {
...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_galactic_marine_jedi_chest_02, "object/tangible/wearables/armor/galactic_marine/jedi_chest_02.iff")
