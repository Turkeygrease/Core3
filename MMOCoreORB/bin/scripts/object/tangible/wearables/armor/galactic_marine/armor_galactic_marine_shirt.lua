...
object_tangible_wearables_armor_galactic_marine_armor_galactic_marine_shirt = object_tangible_wearables_armor_ubese_shared_armor_ubese_shirt:new {
	playerRaces = {
...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_galactic_marine_armor_galactic_marine_shirt, "object/tangible/wearables/armor/galactic_marine/armor_galactic_marine_shirt.iff")
