...
object_tangible_wearables_cape_cape_02 = object_tangible_wearables_cape_shared_cape_kubaz:new {
	playerRaces = {
...
ObjectTemplates:addTemplate(object_tangible_wearables_cape_cape_02, "object/tangible/wearables/cape/cape_02.iff")
