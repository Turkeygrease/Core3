...
object_tangible_wearables_robe_robe_starforge = object_tangible_wearables_robe_shared_robe_starforge:new {
	customName = "Robe",
	playerRaces = {
...
ObjectTemplates:addTemplate(object_tangible_wearables_robe_robe_starforge, "object/tangible/wearables/robe/robe_starforge.iff")
