...
object_tangible_wearables_robe_robe_swtor = object_tangible_wearables_robe_shared_robe_swtor:new {
	customName = "Robe",
	playerRaces = {
...
ObjectTemplates:addTemplate(object_tangible_wearables_robe_robe_swtor, "object/tangible/wearables/robe/robe_swtor.iff")
