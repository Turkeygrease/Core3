...
object_tangible_wearables_robe_exar_cultist_hood_down_s02 = object_tangible_wearables_robe_shared_exar_cultist_hood_down_s02:new {
	playerRaces = {
...
ObjectTemplates:addTemplate(object_tangible_wearables_robe_exar_cultist_hood_down_s02, "object/tangible/wearables/robe/exar_cultist_hood_down_s02.iff")
