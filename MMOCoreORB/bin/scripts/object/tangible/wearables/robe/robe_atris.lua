...
object_tangible_wearables_robe_robe_atris = object_tangible_wearables_robe_shared_robe_atris:new {
	customName = "Robe",
	playerRaces = {
...
ObjectTemplates:addTemplate(object_tangible_wearables_robe_robe_atris, "object/tangible/wearables/robe/robe_atris.iff")
