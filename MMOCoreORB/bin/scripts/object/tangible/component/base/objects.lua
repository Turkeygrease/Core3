...
object_tangible_component_base_shared_weapon_core_base = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/component/base/shared_weapon_core_base.iff"
}

ObjectTemplates:addClientTemplate(object_tangible_component_base_shared_weapon_core_base, "object/tangible/component/base/shared_weapon_core_base.iff")
------------------------------------------------------------------------------------------------------------------------------------
...
--[[
	...
	detailedDescription = "@component_detail:barrel_base",

	gameObjectType = 262153,

	locationReservationRadius = 0,
	lookAtText = "@component_lookat:barrel_base",

	noBuildRadius = 0,

	objectName = "@component_name:barrel_base",
...
--[[
	...
	detailedDescription = "@component_d:base_dna",
	...
	objectName = "@component_n:base_dna",
	onlyVisibleInTools = 0,
...
--[[
	...
	detailedDescription = "@component_d:base_electronic_component",
	...
	objectName = "@component_n:base_electronic_component",
	onlyVisibleInTools = 0,
...
--[[
	...
	detailedDescription = "@component_d:base_food",
	...
	objectName = "@component_n:base_food",
	onlyVisibleInTools = 0,
