object_building_player_player_house_canopy_tatooine_small_style_01 = object_building_player_shared_player_house_canopy_tatooine_small_style_01:new {
    lotSize = 2,
	publicStructure = 0,
...
ObjectTemplates:addTemplate(object_building_player_player_house_canopy_tatooine_small_style_01, "object/building/player/player_house_canopy_tatooine_small_style_01.iff")