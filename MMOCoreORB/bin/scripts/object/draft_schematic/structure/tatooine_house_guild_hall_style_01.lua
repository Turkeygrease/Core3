object_draft_schematic_structure_tatooine_house_guild_hall_style_01 = object_draft_schematic_structure_shared_tatooine_house_guild_hall_style_01:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: Tatooine Guild Hall style 01",
	...
	targetTemplate = "object/tangible/deed/guild_deed/tatooine_guild_style_01_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_structure_tatooine_house_guild_hall_style_01, "object/draft_schematic/structure/tatooine_house_guild_hall_style_01.iff")
