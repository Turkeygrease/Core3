...
object_draft_schematic_weapon_pistol_rebel = object_draft_schematic_weapon_shared_pistol_rebel:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_pistol_rebel, "object/draft_schematic/weapon/pistol_rebel.iff")
