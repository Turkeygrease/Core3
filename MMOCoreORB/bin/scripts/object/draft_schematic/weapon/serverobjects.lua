...
includeFile("draft_schematic/weapon/rifle_trando_hunter_crafted.lua")
includeFile("draft_schematic/weapon/rifle_trando_hunter.lua")
--includeFile("draft_schematic/weapon/lightsaber_two_handed_pvp_bf_gen5.lua")
--includeFile("draft_schematic/weapon/lightsaber_polearm_pvp_bf_gen5.lua")
--includeFile("draft_schematic/weapon/lightsaber_one_handed_pvp_bf_gen5.lua")
includeFile("draft_schematic/weapon/pistol_ion_stunner.lua")
includeFile("draft_schematic/weapon/carbine_republic_sfor.lua")
--includeFile("draft_schematic/weapon/lightsaber_mandalorian.lua")
includeFile("draft_schematic/weapon/blasterfist.lua")
includeFile("draft_schematic/weapon/pistol_pvp.lua")
includeFile("draft_schematic/weapon/jinkins_j1_rifle.lua")
includeFile("draft_schematic/weapon/carbine_heroic_sd.lua")
includeFile("draft_schematic/weapon/som_sword_mustafar_bandit.lua")
includeFile("draft_schematic/weapon/som_2h_sword_tulrus.lua")
includeFile("draft_schematic/weapon/polearm_heroic_sd.lua")
includeFile("draft_schematic/weapon/jakku_fifth_gen_draft.lua")
includeFile("draft_schematic/weapon/som_2h_sword_obsidian.lua")
includeFile("draft_schematic/weapon/pvp_bf_knuckler.lua")
includeFile("draft_schematic/weapon/ep3_loot_firestar.lua")
--includeFile("draft_schematic/weapon/mustafar_ancient_saber.lua")

includeFile("draft_schematic/weapon/carbine_geo.lua")
includeFile("draft_schematic/weapon/rifle_geo_drill.lua")
includeFile("draft_schematic/weapon/som_lance_obsidian.lua")
includeFile("draft_schematic/weapon/som_sword_obsidian.lua")
includeFile("draft_schematic/weapon/sword_wod_scyth.lua")
includeFile("draft_schematic/weapon/pistol_rebel.lua")
includeFile("draft_schematic/weapon/carbine_mandalorian.lua")
includeFile("draft_schematic/weapon/pistol_mandalorian.lua")
includeFile("draft_schematic/weapon/rifle_mandalorian.lua")
includeFile("draft_schematic/weapon/sword_mandalorian.lua")
includeFile("draft_schematic/weapon/ep3_loot_retaliation.lua")
