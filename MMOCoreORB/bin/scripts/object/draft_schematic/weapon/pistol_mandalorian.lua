...
object_draft_schematic_weapon_pistol_mandalorian = object_draft_schematic_weapon_shared_pistol_mandalorian:new {
   ...
   resourceTypes = {"iron_doonium", "metal_ferrous", "metal", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/death_watch_bunker/shared_pistol_de10_barrel.iff", "object/tangible/component/weapon/shared_projectile_pistol_barrel.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
   resourceQuantities = {33, 22, 10, 5, 1, 1, 1},
