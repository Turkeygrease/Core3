...
object_draft_schematic_clothing_armor_mandalorian_imperial_bicep_r = object_draft_schematic_clothing_shared_armor_mandalorian_imperial_bicep_r:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Imperial Crusader Armor Bicep r",
   ...
   targetTemplate = "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_bicep_r.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_mandalorian_imperial_bicep_r, "object/draft_schematic/clothing/armor_mandalorian_imperial_bicep_r.iff")
