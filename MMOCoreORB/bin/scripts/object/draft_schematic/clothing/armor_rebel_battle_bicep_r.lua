...
object_draft_schematic_clothing_armor_rebel_battle_bicep_r = object_draft_schematic_clothing_shared_armor_rebel_battle_bicep_r:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Battle Armor Bicep r",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_rebel_battle_bicep_r, "object/draft_schematic/clothing/armor_rebel_battle_bicep_r.iff")
