...
object_draft_schematic_clothing_armor_mandalorian_imperial_leggings = object_draft_schematic_clothing_shared_armor_mandalorian_imperial_leggings:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Imperial Crusader Armor Leggings",
   ...
   targetTemplate = "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_leggings.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_mandalorian_imperial_leggings, "object/draft_schematic/clothing/armor_mandalorian_imperial_leggings.iff")
