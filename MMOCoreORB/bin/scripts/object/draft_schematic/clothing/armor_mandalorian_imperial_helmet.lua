...
object_draft_schematic_clothing_armor_mandalorian_imperial_helmet = object_draft_schematic_clothing_shared_armor_mandalorian_imperial_helmet:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Imperial Crusader Armor Helmet",
   ...
   targetTemplate = "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_helmet.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_mandalorian_imperial_helmet, "object/draft_schematic/clothing/armor_mandalorian_imperial_helmet.iff")
