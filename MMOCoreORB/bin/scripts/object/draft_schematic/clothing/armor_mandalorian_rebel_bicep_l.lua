...
object_draft_schematic_clothing_armor_mandalorian_rebel_bicep_l = object_draft_schematic_clothing_shared_armor_mandalorian_rebel_bicep_l:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Crusader Armor Bicep l",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_mandalorian_rebel_bicep_l, "object/draft_schematic/clothing/armor_mandalorian_rebel_bicep_l.iff")
