...
object_draft_schematic_clothing_armor_mandalorian_imperial_boots = object_draft_schematic_clothing_shared_armor_mandalorian_imperial_boots:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Imperial Crusader Armor Boots",
   ...
   targetTemplate = "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_boots.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_mandalorian_imperial_boots, "object/draft_schematic/clothing/armor_mandalorian_imperial_boots.iff")
