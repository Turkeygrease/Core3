...
object_draft_schematic_clothing_armor_mandalorian_rebel_belt = object_draft_schematic_clothing_shared_armor_mandalorian_rebel_belt:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Crusader Armor Belt",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_mandalorian_rebel_belt, "object/draft_schematic/clothing/armor_mandalorian_rebel_belt.iff")
