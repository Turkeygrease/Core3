...
object_draft_schematic_clothing_armor_mandalorian_rebel_helmet = object_draft_schematic_clothing_shared_armor_mandalorian_rebel_helmet:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Crusader Armor Helmet",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_mandalorian_rebel_helmet, "object/draft_schematic/clothing/armor_mandalorian_rebel_helmet.iff")
