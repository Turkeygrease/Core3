...
object_draft_schematic_clothing_armor_rebel_battle_gloves = object_draft_schematic_clothing_shared_armor_rebel_battle_gloves:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Battle Armor Gloves",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_rebel_battle_gloves, "object/draft_schematic/clothing/armor_rebel_battle_gloves.iff")
