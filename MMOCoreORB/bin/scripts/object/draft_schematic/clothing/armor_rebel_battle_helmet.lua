...
object_draft_schematic_clothing_armor_rebel_battle_helmet = object_draft_schematic_clothing_shared_armor_rebel_battle_helmet:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Battle Armor Helmet",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_rebel_battle_helmet, "object/draft_schematic/clothing/armor_rebel_battle_helmet.iff")
