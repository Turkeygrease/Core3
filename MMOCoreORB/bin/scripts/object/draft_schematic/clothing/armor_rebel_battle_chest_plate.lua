...
object_draft_schematic_clothing_armor_rebel_battle_chest_plate = object_draft_schematic_clothing_shared_armor_rebel_battle_chest_plate:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Battle Armor Chest Plate",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_rebel_battle_chest_plate, "object/draft_schematic/clothing/armor_rebel_battle_chest_plate.iff")
