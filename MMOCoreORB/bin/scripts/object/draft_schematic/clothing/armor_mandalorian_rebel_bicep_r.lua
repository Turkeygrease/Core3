...
object_draft_schematic_clothing_armor_mandalorian_rebel_bicep_r = object_draft_schematic_clothing_shared_armor_mandalorian_rebel_bicep_r:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Crusader Armor Bicep r",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_mandalorian_rebel_bicep_r, "object/draft_schematic/clothing/armor_mandalorian_rebel_bicep_r.iff")
