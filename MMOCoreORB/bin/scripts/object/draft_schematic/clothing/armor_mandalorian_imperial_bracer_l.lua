...
object_draft_schematic_clothing_armor_mandalorian_imperial_bracer_l = object_draft_schematic_clothing_shared_armor_mandalorian_imperial_bracer_l:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Imperial Crusader Armor Bracer l",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_mandalorian_imperial_bracer_l, "object/draft_schematic/clothing/armor_mandalorian_imperial_bracer_l.iff")
