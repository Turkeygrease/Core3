...
object_draft_schematic_clothing_armor_rebel_battle_belt = object_draft_schematic_clothing_shared_armor_rebel_battle_belt:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Battle Armor Belt",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_rebel_battle_belt, "object/draft_schematic/clothing/armor_rebel_battle_belt.iff")
