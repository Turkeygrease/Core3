...
object_draft_schematic_clothing_armor_mandalorian_imperial_gloves = object_draft_schematic_clothing_shared_armor_mandalorian_imperial_gloves:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Imperial Crusader Armor Gloves",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_mandalorian_imperial_gloves, "object/draft_schematic/clothing/armor_mandalorian_imperial_gloves.iff")
