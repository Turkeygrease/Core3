...
object_draft_schematic_clothing_armor_mandalorian_rebel_gloves = object_draft_schematic_clothing_shared_armor_mandalorian_rebel_gloves:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Crusader Armor Gloves",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_mandalorian_rebel_gloves, "object/draft_schematic/clothing/armor_mandalorian_rebel_gloves.iff")
