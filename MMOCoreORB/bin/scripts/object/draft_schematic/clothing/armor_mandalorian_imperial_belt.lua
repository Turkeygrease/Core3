...
object_draft_schematic_clothing_armor_mandalorian_imperial_belt = object_draft_schematic_clothing_shared_armor_mandalorian_imperial_belt:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Imperial Crusader Armor Belt",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_mandalorian_imperial_belt, "object/draft_schematic/clothing/armor_mandalorian_imperial_belt.iff")
