...
object_draft_schematic_clothing_armor_mandalorian_rebel_boots = object_draft_schematic_clothing_shared_armor_mandalorian_rebel_boots:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Crusader Armor Boots",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_mandalorian_rebel_boots, "object/draft_schematic/clothing/armor_mandalorian_rebel_boots.iff")
