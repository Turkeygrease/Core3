...
object_draft_schematic_clothing_armor_rebel_battle_leggings = object_draft_schematic_clothing_shared_armor_rebel_battle_leggings:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Battle Armor leggings",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_armor_rebel_battle_leggings, "object/draft_schematic/clothing/armor_rebel_battle_leggings.iff")
